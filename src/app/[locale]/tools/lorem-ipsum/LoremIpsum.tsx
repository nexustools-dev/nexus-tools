...
const LOREM_WORDS = [
  ...
  "reprehenderit", "blanditiis", "praesentium", "voluptatum", "deleniti",
  "atque", "corrupti", "quos", "quas", "molestias", "excepturi", "occaecati",
  "cupiditate", "provident", "similique", "mollitia", "animi", "sapiente",
  "delectus", "rerum", "hic", "tenetur", "eligendi", "optio", "cumque",
  "nihil", "impedit", "quo", "minus", "maxime", "placeat", "facere",
  "possimus", "assumenda", "repellendus", "temporibus", "quibusdam",
  "illum", "soluta", "nobis", "debitis", "necessitatibus", "saepe",
  "eveniet", "voluptates", "repudiandae", "recusandae", "itaque",
  "earum", "harum", "quidem", "reiciendis",
];
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-zinc-600">
              {typeLabel} &middot; {t("statsWords", { words: wordCount })} &middot; {t("statsChars", { chars: charCount.toLocaleString() })}
            </span>
          </div>
