        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex gap-2 items-center">
            <span className="text-xs text-zinc-600">
              {stats.words} {t('wordCount')} &middot; {stats.chars} {t('charCount')}
            </span>
            <button
            ...
            {CASE_KEYS.map((key) => (
              ...
              >
                <div className="min-w-0">
                  <div className="text-xs text-zinc-500 mb-0.5" translate="no">
                    {t(key)}
                  </div>
                  <code className="font-mono text-sm text-zinc-300 break-all" translate="no">
                    {results[key]}
                  </code>
                </div>
                <button
