...
export default async function CidrCalculatorPage({ params }: Props) {
  ...
  const t = await getTranslations({ locale, namespace: 'cidrCalculator' });
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      <ToolJsonLd name={t('heading')} description={t('metadata.description')} url={`https://toolnexus.dev/${locale}/tools/cidr-calculator`} faq={faq} />
