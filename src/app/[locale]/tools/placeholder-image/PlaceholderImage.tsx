      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  value={bgColor}
                  onChange={(e) => setBgColor(e.target.value)}
                  className="flex-1 bg-zinc-900 border border-zinc-800 rounded px-3 py-2 font-mono text-xs focus:outline-none focus:border-pink-500"
                />
              </div>
            </div>
            <div>
          ...
          <div className="flex gap-3">
            <button
              onClick={downloadPng}
              className="flex-1 py-2.5 rounded-lg bg-pink-600 hover:bg-pink-500 text-white font-medium text-sm transition-colors"
            >
              {t('downloadPng')}
            </button>
            <button
            ...
            <div className="grid grid-cols-4 gap-2">
              {PRESETS.map((p) => (
                ...
                >
                  ...
                  <code className="text-zinc-500 text-[10px] font-mono" translate="no">
                    {p.w}×{p.h}
                  </code>
                </button>
              ))}
