...
export default async function JwtGeneratorPage({ params }: Props) {
  ...
  const t = await getTranslations({ locale, namespace: 'jwtGenerator' });
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      <ToolJsonLd name={t('heading')} description={t('metadata.description')} url={`https://toolnexus.dev/${locale}/tools/jwt-generator`} faq={faq} />
