...
const PRESETS: { key: string; shadows: Shadow[] }[] = [
  {
    key: 'subtle',
    shadows: [
      { x: 0, y: 1, blur: 3, spread: 0, color: '#000000', opacity: 10, inset: false },
      { x: 0, y: 1, blur: 2, spread: -1, color: '#000000', opacity: 10, inset: false },
    ],
  },
  {
    key: 'medium',
  ...
  },
  {
    key: 'heavy',
    shadows: [
      { x: 0, y: 20, blur: 25, spread: -5, color: '#000000', opacity: 25, inset: false },
      { x: 0, y: 8, blur: 10, spread: -6, color: '#000000', opacity: 25, inset: false },
    ],
  },
  {
    key: 'insetShadow',
    shadows: [{ x: 0, y: 2, blur: 4, spread: 0, color: '#000000', opacity: 20, inset: true }],
  },
  {
    key: 'layered',
    shadows: [
  ...
  {
    key: 'colored',
    shadows: [{ x: 0, y: 4, blur: 14, spread: -3, color: '#3b82f6', opacity: 50, inset: false }],
  },
  {
    key: 'neonGlow',
    shadows: [
      { x: 0, y: 0, blur: 20, spread: 2, color: '#22d3ee', opacity: 50, inset: false },
      { x: 0, y: 0, blur: 40, spread: 4, color: '#22d3ee', opacity: 25, inset: false },
    ],
  },
];
...
export function BoxShadowGenerator() {
  ...
  const updateShadow = useCallback(
    (idx: number, key: keyof Shadow, val: number | string | boolean) => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded bg-violet-600 hover:bg-violet-500 disabled:opacity-40 disabled:cursor-not-allowed text-xs font-medium transition-colors"
            >
              + {t('addShadow')}
            </button>
          </div>
          ...
          <div className="space-y-4 max-h-80 overflow-y-auto pr-1">
            {shadows.map((s, idx) => (
              ...
              >
                ...
                {(
                  [
                    ['x', 'horizontalOffset', -50, 50],
                    ['y', 'verticalOffset', -50, 50],
                    ['blur', 'blur', 0, 100],
                    ['spread', 'spread', -50, 50],
                  ] as const
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4">
        ...
        <code className="block font-mono text-sm text-violet-300 break-all" translate="no">
          {cssOutput}
        </code>
      </div>
